  ...
  <div class="container_fluid">
    ...
    <div class="wrapper">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="img"><img class="img-responsive img-thumbnail" src="https://sun9-83.userapi.com/impg/TawkFxwko-pywh1M_6CzgKxytVZx9iSoOFCxgQ/QQ-6DhaFS_Y.jpg?size=1920x1080&quality=96&sign=1d81929d8e8f36184be96f78bc5c00fe&type=album" style="width: 100%;"></div>
                  <h1>Владельцы</h1>
                  <hr>
    ...
    echo '<div class="acc-head text-center">
              ...
              <div class="acc-body">
                <table class="hidden-xs" cellspacing="5" cellpadding="10" width="100%">
                  <tr><th>'.$row['vk_name'].'';
        if ($row['pos1'] == 'Gl.Owner' && $row['vk_link'] == 'https://vk.com/id308881443') {
