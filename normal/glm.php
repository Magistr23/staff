  ...
  <div class="container_fluid">
    ...
    <div class="wrapper">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="img"><img class="img-responsive img-thumbnail" src="https://sun9-86.userapi.com/impg/Y0vD75hZ_Zu1hMoZXKCJx6zrpv4SpYKZRisuqw/oXQp6Njg7F4.jpg?size=1920x1080&quality=96&sign=60aa2a09cde6a01510fbbd595e407d47&type=album"></div>
...
Ну и как же без правил, вы должны знать их на зубок или же большую их часть. Все правила написаны на странице "<a href="http://helperstaff.ru">Главная</a>"</p></div>
...
<div class="collapse" id="collapseExample">
  <div class="well">
    <ul style = "list-style-type:circle">
              ...
              <li> Если нет Хелперов, Модеров - работаем сами, не будем тратить время зря :)</li></ul>
  </div>
</div>
    ...
    echo '<div class="col-sm-3"></div>
        ...
        if ($i <= 0) {
           echo '<p>Гл.Модератора нет </p><div class="col-sm-3"></div>
