...
<div class="margin-8"></div>           
  ...
  <li>2.5 Донат можно перенести на другой ник. Стоимость 300 рублей. Покупка у <a href="http://vk.com/summerfibbs">Миши Степанова</a></p></li>
</ul></div>
...
<ul style = "list-style-type:square"><div class="alert alert-success" role="alert">
  <li>3.4 Запрещается распространение вредоносного контента - Бан навсегда</li>
...
<p><h1>По всем вопросам о правилах, обращайтесь к <a href="https://vk.com/summerfibbs">Мише Степанову</a></h1></p>
  ...
  $mysqli = new mysqli ('localhost', 'cg47894_mainbd', '12345', 'cg47894_mainbd');
	$mysqli->query ("SET NAMES 'utf8'");
          ...
          $res_GlKur = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'OcHoBa'");
          $res_GlKurS1 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'OcHoBa'");
          $res_GlKurS2 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'OcHoBa'");
          $res_GlKurS3 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'OcHoBa'");
          $res_GlKurS4 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'OcHoBa'");
          $res_Sr1Kur = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'luni444ko'");
          $res_Sr1KurS1 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'luni444ko'");
          $res_Sr2Kur = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'VLaDoS_1'");
          $res_Sr2KurS1 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'VLaDoS_1'");
          $res_Sr3Kur = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'Desppy8'");
          $res_Sr3KurS1 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'Desppy8'");
          $res_Sr3KurS2 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'Desppy8'");
          $res_Sr3KurS3 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'Desppy8'");
          $res_Sr3KurS4 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'Desppy8'");
          $res_Ml1Kur = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'HappyCatGx9'");
          $res_Ml1KurS1 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'HappyCatGx9'");
          $res_Ml1KurS2 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'HappyCatGx9'");
          $res_Ml1KurS3 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'HappyCatGx9'");
          $res_Ml1KurS4 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'HappyCatGx9'");
          $res_Ml2Kur = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'kostya23475'");
          $res_Ml2KurS1 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'kostya23475'");
          $res_Ml2KurS2 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'kostya23475'");
          $res_Ml2KurS3 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'kostya23475'");
          $res_Ml2KurS4 = $mysqli->query("SELECT * FROM `kurators` WHERE `kurator` = 'kostya23475'");

          function tableGlKur ($res_GlKur) {
          	while (($row = $res_GlKur->fetch_assoc()) !=false ) {
            	echo $row['kurator'];
            }
          }
          
          function tableGlKurS1 ($res_GlKurS1) {
          	while (($row = $res_GlKurS1->fetch_assoc()) !=false ) {
            	echo $row['sub1'];
            }
          }
          
          function tableGlKurS2 ($res_GlKurS2) {
          	while (($row = $res_GlKurS2->fetch_assoc()) !=false ) {
            	echo $row['sub2'];
            }
          }
          
          function tableGlKurS3 ($res_GlKurS3) {
          	while (($row = $res_GlKurS3->fetch_assoc()) !=false ) {
            	echo $row['sub3'];
            }
          }
          
          function tableGlKurS4 ($res_GlKurS4) {
          	while (($row = $res_GlKurS4->fetch_assoc()) !=false ) {
            	echo $row['sub4'];
            }
          }
          //------------------------------------------------------------------------
          function tableSr1Kur ($res_Sr1Kur) {
          	while (($row = $res_Sr1Kur->fetch_assoc()) !=false ) {
            	echo $row['kurator'];
            }
          }
          
          function tableSr1KurS1 ($res_Sr1KurS1) {
          	while (($row = $res_Sr1KurS1->fetch_assoc()) !=false ) {
            	echo $row['sub1'];
            }
          }
          //-------------------------------------------------------------------------
          function tableSr2Kur ($res_Sr2Kur) {
          	while (($row = $res_Sr2Kur->fetch_assoc()) !=false ) {
            	echo $row['kurator'];
            }
          }
          
          function tableSr2KurS1 ($res_Sr2KurS1) {
          	while (($row = $res_Sr2KurS1->fetch_assoc()) !=false ) {
            	echo $row['sub1'];
            }
          }
          //--------------------------------------------------------------------------
          function tableSr3Kur ($res_Sr3Kur) {
          	while (($row = $res_Sr3Kur->fetch_assoc()) !=false ) {
            	echo $row['kurator'];
            }
          }
          
          function tableSr3KurS1 ($res_Sr3KurS1) {
          	while (($row = $res_Sr3KurS1->fetch_assoc()) !=false ) {
            	echo $row['sub1'];
            }
          }
          
          function tableSr3KurS2 ($res_Sr3KurS2) {
          	while (($row = $res_Sr3KurS2->fetch_assoc()) !=false ) {
            	echo $row['sub2'];
            }
          }
          
          function tableSr3KurS3 ($res_Sr3KurS3) {
          	while (($row = $res_Sr3KurS3->fetch_assoc()) !=false ) {
            	echo $row['sub3'];
            }
          }
          
          function tableSr3KurS4 ($res_Sr3KurS4) {
          	while (($row = $res_Sr3KurS4->fetch_assoc()) !=false ) {
            	echo $row['sub4'];
            }
          }
          //--------------------------------------------------------------------------
          function tableMl1Kur ($res_Ml1Kur) {
          	while (($row = $res_Ml1Kur->fetch_assoc()) !=false ) {
            	echo $row['kurator'];
            }
          }
          
          function tableMl1KurS1 ($res_Ml1KurS1) {
          	while (($row = $res_Ml1KurS1->fetch_assoc()) !=false ) {
            	echo $row['sub1'];
            }
          }
          
          function tableMl1KurS2 ($res_Ml1KurS2) {
          	while (($row = $res_Ml1KurS2->fetch_assoc()) !=false ) {
            	echo $row['sub2'];
            }
          }
          
          function tableMl1KurS3 ($res_Ml1KurS3) {
          	while (($row = $res_Ml1KurS3->fetch_assoc()) !=false ) {
            	echo $row['sub3'];
            }
          }
          
          function tableMl1KurS4 ($res_Ml1KurS4) {
          	while (($row = $res_Ml1KurS4->fetch_assoc()) !=false ) {
            	echo $row['sub4'];
            }
          }
          //--------------------------------------------------------------------------
          function tableMl2Kur ($res_Ml2Kur) {
          	while (($row = $res_Ml2Kur->fetch_assoc()) !=false ) {
            	echo $row['kurator'];
            }
          }
          
          function tableMl2KurS1 ($res_Ml2KurS1) {
          	while (($row = $res_Ml2KurS1->fetch_assoc()) !=false ) {
            	echo $row['sub1'];
            }
          }
          
          function tableMl2KurS2 ($res_Ml2KurS2) {
          	while (($row = $res_Ml2KurS2->fetch_assoc()) !=false ) {
            	echo $row['sub2'];
            }
          }
          
          function tableMl2KurS3 ($res_Ml2KurS3) {
          	while (($row = $res_Ml2KurS3->fetch_assoc()) !=false ) {
            	echo $row['sub3'];
            }
          }
          
          function tableMl2KurS4 ($res_Ml2KurS4) {
          	while (($row = $res_Ml2KurS4->fetch_assoc()) !=false ) {
            	echo $row['sub4'];
            }
          }
          //--------------------------------------------------------------------------
         ...
         echo '
            ...
            <tr align="center"><tr align="center"><td colspan="3" width="200" bgcolor="#FFDEAD">'; tableGlKur ($res_GlKur); echo '</td><td colspan="5" bgcolor="#D2691E">Администрация</td></tr>
            <tr align="center"><td bgcolor="#FFFACD">'; tableGlKurS1 ($res_GlKurS1); echo '</td><td bgcolor="#FFFACD">'; tableGlKurS2 ($res_GlKurS2); echo '</td><td bgcolor="#FFFACD">'; tableGlKurS3 ($res_GlKurS3); echo '</td><td colspan="4"bgcolor="#FFD700">Ст. и Гл.Модераторы</td></tr>
            
            <tr align="center"><td bgcolor="#ADD8E6">'; tableSr1KurS1 ($res_Sr1KurS1); echo '</td><td bgcolor="#ADD8E6">'; tableSr2KurS1 ($res_Sr2KurS1); echo '</td><td bgcolor="#ADD8E6">';  echo '<td bgcolor="#00BFFF">Модераторы</td></tr>
            <tr align="center"><td bgcolor="#90EE90">'; tableMl1KurS1 ($res_Ml1KurS1); echo '</td><td bgcolor="#90EE90">'; tableMl2KurS1 ($res_Ml2KurS1); echo '</td><td bgcolor="#90EE90">'; tableSr3KurS1 ($res_Sr3KurS1); echo '</td><td  rowspan="4" bgcolor="#00FF7F" width="200">Хелперы</td></tr>
            <tr align="center"><td bgcolor="#90EE90">'; tableMl1KurS2 ($res_Ml1KurS2); echo '</td><td bgcolor="#90EE90">'; tableMl2KurS2 ($res_Ml2KurS2); echo '</td><td bgcolor="#90EE90">'; tableSr3KurS2 ($res_Sr3KurS2); echo '</td></tr>
            <tr align="center"><td bgcolor="#90EE90">'; tableMl1KurS3 ($res_Ml1KurS3); echo '</td><td bgcolor="#90EE90">'; tableMl2KurS3 ($res_Ml2KurS3); echo '</td><td bgcolor="#90EE90">'; tableSr3KurS3 ($res_Sr3KurS3); echo '</td></tr>
            <tr align="center"><td bgcolor="#90EE90">'; tableMl1KurS4 ($res_Ml1KurS4); echo '</td><td bgcolor="#90EE90">'; tableMl2KurS4 ($res_Ml2KurS4); echo '</td><td bgcolor="#90EE90">'; tableSr3KurS4 ($res_Sr3KurS4); echo '</td></tr>'; 
          echo '</table>';
 	$mysqli->close ();
        ?>
          </div>
